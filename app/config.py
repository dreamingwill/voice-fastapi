...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--database_url", type=str, default=DATABASE_URL)
    parser.add_argument("--speaker_provider", type=str, default="cpu")
    parser.add_argument("--speaker_num_threads", type=int, default=4)
    parser.add_argument("--speaker_rknn_feature_dim", type=int, default=80)
    parser.add_argument("--speaker_rknn_num_frames", type=int, default=300)
    parser.add_argument("--speaker_rknn_frame_length_ms", type=float, default=25.0)
